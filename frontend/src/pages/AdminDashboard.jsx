            ...
            <div className="flex">
                <aside className="w-1/4 bg-gray-800 p-6 h-[90.25vh]">
                    <nav className="space-y-4">
                        <Link to="/manage-users" className="block py-2 px-4 rounded hover:bg-gray-700">Manage User Details</Link>
                        <Link to="/manage-products" className="block py-2 px-4 rounded hover:bg-gray-700">Manage Product Details</Link>
                        <Link to="/manage-comments" className="block py-2 px-4 rounded hover:bg-gray-700">Manage Comments</Link>
                    </nav>
                </aside>
                <main className="w-3/4 p-6">
                    ...
                    <div className="grid grid-cols-3 gap-6 text-center">
                        ...
                        <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
                            <h2 className="text-3xl font-semibold mb-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">Total Products</h2>
                            <p className="text-5xl font-bold">{totalProducts}</p>
                        </div>
                        <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
                            <h2 className="text-3xl font-semibold mb-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">Total Comments</h2>
