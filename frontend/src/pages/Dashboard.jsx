    ...
    <div className='bg-gradient-to-b from-black via-gray-950 to-gray-900'>
      <div className="flex items-center justify-between p-6 bg-gray-900 text-white h-[600px] gap-5">
        <div className="md:w-2/4 md:ml-10 text-center md:text-left">
          <h1 className="text-6xl font-bold mb-10 md:mb-4 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent">Welcome to<br/>Mario</h1>
      ...
      <div className="py-12 bg-gradient-to-b from-black via-gray-950 to-gray-900 px-8">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-r from-pink-400 via-purple-500 to-blue-500 p-6 rounded-lg shadow-lg">
      ...
      <div className="py-12 bg-gray-900 px-8">
